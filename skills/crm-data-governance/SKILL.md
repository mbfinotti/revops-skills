...
- System of record is designated per field, never per system or object. Every other copy is explicitly derived. Blank never overwrites populated, whatever the timestamps say.
